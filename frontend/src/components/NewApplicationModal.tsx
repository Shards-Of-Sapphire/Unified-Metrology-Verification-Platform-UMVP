...
export const NewApplicationModal: React.FC<NewApplicationModalProps> = ({
  ...
  const [businessName, setBusinessName] = useState('Apex Logistics & Retail Hub');
  const [installationAddress, setInstallationAddress] = useState('Plot 88, Okhla Industrial Area Phase-III');
